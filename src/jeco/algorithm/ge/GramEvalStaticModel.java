...
import jeco.operator.evaluator.AbstractPopPredictor;
...
public class GramEvalStaticModel extends AbstractProblemGE {
    ...
    public GramEvalStaticModel(Properties properties, int threadId) throws IOException {
        ...
        dataTable = new NormalizedDataTable(this, properties.getProperty("TrainingPath"), Boolean.valueOf(properties.getProperty("NormalizeTable","true")));
